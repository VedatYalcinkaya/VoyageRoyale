...
function AddCar() {
    ...
    const carCategories:CarCategory[] = useAppSelector(state => state.carCategory.data);
    const carFuels:CarFuelType[] = useAppSelector(state => state.carFuelType.data);
    const carGears:CarGearType[] = useAppSelector(state => state.carGearType.data);
    const carColors:GetAllColorResponse[] = useAppSelector(state => state.carColor.data);
    const carModels:GetAllModelResponse[] = useAppSelector(state => state.carModel.data);
    const positions:Position[] = useAppSelector(state => state.positionList.data);
    ...
    return (
        ...
        >
            ...
            <Form>
                ...
                <SecondFormikInput name="dailyPrice" label="Daily Price" type="number"/>
                <br />
                <br />
                
                <Field as={Select} name="carTypeId">
                    <MenuItem value="0">Select A Category</MenuItem>
                    {carCategories.map((category) => <MenuItem value={category.id} key={category.id}>{category.name}</MenuItem>)}
                </Field>
                <br />
                <br />
                ...
                <Field as={Select} name="fuelTypeId">
                    ...
                    {carFuels.map((fuel) => <MenuItem value={fuel.id} key={fuel.id}>{fuel.fuel_name}</MenuItem>)}
                </Field>
                <br />
                <br />
                ...
                <Field as={Select} name="gearTypeId">
                    <MenuItem value="0">Select A Category</MenuItem>
                    {carGears.map((gear) => <MenuItem value={gear.id} key={gear.id}>{gear.name}</MenuItem>)}
                </Field>
                <br />
                <br />
                ...
                <Field as={Select} name="positionId">
                    ...
                    {positions.map((position) => <MenuItem value={position.id} key={position.id}>{position.city}</MenuItem>)}
                </Field>
                <br />
                <br />
                ...
                <Field as={Select} name="colorId">
                    ...
                    {carColors.map((color) => <MenuItem value={color.id} key={color.id}>{color.name}</MenuItem>)}
                </Field>
                <br />
                <br />
                ...
                <Field as={Select} name="modelId">
                    ...
                    {carModels.map((model) => <MenuItem value={model.id} key={model.id}>{model.name}</MenuItem>)}
                </Field>
                <br />
                <br />
